...
if(p.package!=="@wasm-game-framework/browser"||p.version!=="0.7.1"||!p.bootstrapSha256)process.exit(1);
...
printf 'Static Wolfenstein 3D web build passed framework 0.7.1 and game-data boundary checks.\n'
